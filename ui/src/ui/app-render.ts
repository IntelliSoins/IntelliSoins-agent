        ...
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src=${basePath ? `${basePath}/favicon.svg` : "/favicon.svg"} alt="OpenIntellisoins" />
            </div>
            <div class="brand-text">
              <div class="brand-title">OPENINTELLISOINS</div>
              <div class="brand-sub">${t("header.dashboard")}</div>
            </div>
          </div>
        </div>
        ...
        ${
          availableUpdate
            ? html`<div class="update-banner callout danger" role="alert">
              <strong>Mise à jour disponible :</strong> v${availableUpdate.latestVersion}
              (running v${availableUpdate.currentVersion}).
              <button
                class="btn btn--sm update-banner__btn"
                ?disabled=${state.updateRunning || !state.connected}
                @click=${() => runUpdate(state)}
              >${state.updateRunning ? "Mise à jour…" : "Mettre à jour"}</button>
            </div>`
            : nothing
        }
