  ...
  return html`
    <section class="card">
      ...
      ${
        filtered.length === 0
          ? html`
              <div class="muted" style="margin-top: 16px">${t("skillsView.noSkills")}</div>
            `
          : html`
    ...
    <div class="list-item">
          ...
          missing.length > 0
            ? html`
              <div class="muted" style="margin-top: 6px;">
                ${t("skillsView.missing")}: ${missing.join(", ")}
              </div>
            `
            : nothing
        }
      ...
      <div class="list-meta">
        <div class="row" style="justify-content: flex-end; flex-wrap: wrap;">
          ...
          >
            ${skill.disabled ? t("skillsView.enable") : t("skillsView.disable")}
          </button>
          ${
            canInstall
              ? html`<button
