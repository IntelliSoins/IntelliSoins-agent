...
const STATUS_TABS: StatusTabDef[] = [
  { id: "all", label: t("skillsPage.filters.all") },
  { id: "ready", label: t("skillsPage.filters.ready") },
  { id: "needs-setup", label: t("skillsPage.filters.needsSetup") },
  { id: "disabled", label: t("skillsPage.filters.disabled") },
];
            ...
            : props.clawhubDetailError
              ...
              : detail?.skill
                ? html`
                  ...
                  `
                : html`<div class="muted">${t("skillsPage.skillNotFound")}</div>`}
        </div>
      </div>
    </dialog>
  `;
