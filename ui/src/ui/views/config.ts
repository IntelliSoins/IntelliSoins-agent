...
const SECTIONS: Array<{ key: string; labelKey: string }> = [
  { key: "env", labelKey: "configView.sectionEnvironment" },
  { key: "update", labelKey: "configView.sectionUpdates" },
  { key: "agents", labelKey: "configView.sectionAgents" },
  { key: "auth", labelKey: "configView.sectionAuthentication" },
  { key: "channels", labelKey: "configView.sectionChannels" },
  { key: "messages", labelKey: "configView.sectionMessages" },
  { key: "commands", labelKey: "configView.sectionCommands" },
  { key: "hooks", labelKey: "configView.sectionHooks" },
  { key: "skills", labelKey: "configView.sectionSkills" },
  { key: "tools", labelKey: "configView.sectionTools" },
  { key: "gateway", labelKey: "configView.sectionGateway" },
  { key: "wizard", labelKey: "configView.sectionSetupWizard" },
];
...
export function renderConfig(props: ConfigProps) {
  ...
  const extraSections = Object.keys(schemaProps)
    ...
    .map((k) => ({ key: k, labelKey: null as string | null }));

  const allSections = [...availableSections, ...extraSections] as Array<{
    key: string;
    ...
    <div class="config-layout">
      ...
      <aside class="config-sidebar">
        <div class="config-sidebar__header">
          <div class="config-sidebar__title">${t("configView.sidebarTitle")}</div>
          <span
            class="pill pill--sm ${
        ...
        <div class="config-search">
          <div class="config-search__input-row">
            ...
            <input
              ...
              placeholder=${t("searchCommon.settings")}
          ...
          <div class="config-search__hint">
            <span class="config-search__hint-label" id="config-tag-filter-label">${t("configView.tagFiltersLabel")}</span>
            <details class="config-search__tag-picker">
              <summary class="config-search__tag-trigger" aria-labelledby="config-tag-filter-label">
                ${
                  selectedTags.size === 0
                    ? html`
                        <span class="config-search__tag-placeholder">${t("configView.addTags")}</span>
                      `
                    : html`
          ...
          ${allSections.map(
            (section) => html`
              ...
              >
                ...
                >
                <span class="config-nav__label">${section.labelKey ? t(section.labelKey) : section.key.charAt(0).toUpperCase() + section.key.slice(1)}</span>
              </button>
            `,
          )}
        </nav>
                  ...
                  <span class="config-changes-badge"
                    >${
                      props.formMode === "raw"
                        ...
                        : t(
                            diff.length !== 1
                              ? "configView.unsavedChangesCountPlural"
                              : "configView.unsavedChangesCount",
            ...
            ? html`
              <details class="config-diff">
                <summary class="config-diff__summary">
                  <span
                    >${t(diff.length !== 1 ? "configView.viewPendingChangesPlural" : "configView.viewPendingChanges", { count: String(diff.length) })}</span
                  >
                  <svg
            ...
            props.formMode === "form"
              ...
              : html`
                <label class="field config-raw-field">
                  <span>${t("configView.rawJsonLabel")}</span>
                  <textarea
                    .value=${props.raw}
                    @input=${(e: Event) =>
