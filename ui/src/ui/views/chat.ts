      ...
      ${attachments.map(
        (att) => html`
          <div class="chat-attachment">
            <img
              src=${att.dataUrl}
              alt=${t("chatView.attachmentPreviewAlt")}
                  ...
                  (item) => html`
                    <div class="chat-queue__item">
                      ...
                      <button
                        ...
                        type="button"
                        aria-label=${t("chatView.removeQueuedMessage")}
      ...
      ${
        props.showNewMessages
          ? html`
            ...
            >
              ${t("chatView.newMessages")} ${icons.arrowDown}
            </button>
          `
          : nothing
      }
      ...
      <div class="chat-compose">
        ...
        <div class="chat-compose__row">
          <label class="field chat-compose__field">
            <span>${t("chatView.messageLabel")}</span>
            <textarea
...
function buildChatItems(props: ChatProps): Array<ChatItem | MessageGroup> {
  ...
  if (historyStart > 0) {
    items.push({
      ...
      message: {
        role: "system",
        content: t("chatView.historyNotice")
  ...
  for (let i = historyStart; i < history.length; i++) {
    ...
    if (marker && marker.kind === "compaction") {
      items.push({
        ...
        label: t("chatView.compactionDivider"),
