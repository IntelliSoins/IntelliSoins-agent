...
export const zh_TW: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "在手機上？從桌面執行 intellisoins dashboard --no-open 複製完整 URL（包括 #token=...）。",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — 使用 intellisoins models auth 重新驗證",
  ...
  login: {
    ...
    failure: {
      ...
      pairing: {
        ...
        stepList: "在 Gateway 主機上執行 intellisoins devices list。",
        stepApproveId: "核准此要求：intellisoins devices approve {requestId}。",
      ...
      protocol: {
        ...
        stepDashboard:
          "使用 intellisoins dashboard 重新開啟提供的 dashboard，確保 UI 和 Gateway 來自同一安裝。",
        stepDevUi: "如果使用 pnpm ui:dev，請依目前 checkout 重新建置或重新啟動開發 UI。",
        stepRestart: "更新 IntelliSoins 後重新啟動 Gateway，使其提供目前協定。",
      },
      network: {
        title: "無法連線",
        summary: "瀏覽器無法完成 Gateway 連線。重試憑證前請檢查目標與傳輸。",
        stepGateway: "使用 intellisoins status 或 intellisoins gateway run 確認 Gateway 正在執行。",
        stepUrl: "檢查 WebSocket URL；當 Gateway 位於 HTTPS/Tailscale Serve 後方時使用 wss://。",
        stepDashboard:
          "使用 intellisoins dashboard --no-open 重新開啟 dashboard，以重新複製目前 URL 與驗證詳細資料。",
      },
    },
  },
  chat: {
