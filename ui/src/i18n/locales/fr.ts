...
export const fr: TranslationMap = {
  ...
  channels: {
    ...
    cards: {
      botStatusSubtitle: "État du bot et configuration du canal.",
      slackSubtitle: "État du mode socket et configuration du canal.",
      signalSubtitle: "État signal-cli et configuration du canal.",
      imessageSubtitle: "État du pont macOS et configuration du canal.",
      whatsappSubtitle: "Lier WhatsApp Web et surveiller la connexion.",
      googleChatSubtitle: "État du webhook Chat API et configuration du canal.",
      nostrSubtitle: "Messages directs décentralisés via relais Nostr (NIP-04).",
    },
    nostr: {
      profile: "Profil",
  ...
  nodes: {
    binding: {
      ...
      any: "tout",
      noNodesWithSystemRun: "Aucun nœud avec system.run disponible.",
      noAgentsFound: "Aucun agent trouvé.",
      defaultAgent: "agent par défaut",
      agent: "agent",
      usesDefault: "utilise le défaut ({value})",
      overrideBinding: "surcharge : {value}",
      binding: "Liaison",
      useDefault: "Utiliser le défaut",
    },
    execApprovals: {
      title: "Approbations exec",
      subtitleBefore: "Liste blanche et politique d'approbation pour ",
      subtitleAfter: ".",
      loadHint: "Chargez les approbations exec pour modifier les listes blanches.",
      target: "Cible",
      targetHint:
        "Le gateway modifie les approbations locales ; le nœud modifie le nœud sélectionné.",
      host: "Hôte",
      gateway: "Gateway",
      selectNode: "Sélectionner un nœud",
      noNodesAdvertise: "Aucun nœud n'expose encore les approbations exec.",
      scope: "Portée",
      defaults: "Valeurs par défaut",
      securityTitle: "Sécurité",
      securityDefaultMode: "Mode de sécurité par défaut.",
      securityDefaultValue: "Par défaut : {value}.",
      askTitle: "Demander",
      askDefaultPolicy: "Politique de demande par défaut.",
      askDefaultValue: "Par défaut : {value}.",
      askFallbackTitle: "Repli de demande",
      askFallbackUnavailable: "Appliqué lorsque l'invite UI n'est pas disponible.",
      askFallbackDefaultValue: "Par défaut : {value}.",
      fallback: "Repli",
      autoAllowSkillsTitle: "Autoriser automatiquement les CLI de compétences",
      autoAllowSkillsDefault: "Autoriser les exécutables de compétences listés par le gateway.",
      autoAllowSkillsUsingDefault: "Utilise le défaut ({value}).",
      autoAllowSkillsOverride: "Surcharge ({value}).",
      useDefault: "Utiliser le défaut",
      useDefaultWithValue: "Utiliser le défaut ({value})",
      on: "activé",
      off: "désactivé",
      securityOption: {
        deny: "Refuser",
      ...
      allowlist: {
        title: "Liste blanche",
        subtitle: "Motifs glob insensibles à la casse.",
        addPattern: "Ajouter un motif",
        noEntries: "Aucune entrée dans la liste blanche pour l'instant.",
    ...
    title: "Nœuds",
    subtitle: "Appareils appairés et liaisons actives.",
    noNodesFound: "Aucun nœud trouvé.",
    devices: {
      title: "Appareils",
      subtitle: "Demandes d'appairage et jetons de rôle.",
      pending: "En attente",
      paired: "Appairés",
      noPairedDevices: "Aucun appareil appairé.",
      approvalNotes: {
        scopeUpgrade: "élargissement de portée nécessite une approbation",
        roleUpgrade: "changement de rôle nécessite une approbation",
        reApproval: "détails de reconnexion modifiés ; approbation requise",
        newPairing: "nouvelle demande d'appairage d'appareil",
      },
      repairSuffix: " · réparation",
      requested: "demandé {time}",
      requestedAccess: "demandé : {access}",
      approvedNow: "approuvé maintenant : {access}",
      approve: "Approuver",
      reject: "Rejeter",
      accessSummary: "rôles : {roles} · portées : {scopes}",
      roles: "rôles : {roles}",
      scopes: "portées : {scopes}",
      tokensNone: "Jetons : aucun",
      tokens: "Jetons",
      tokenStatus: {
        revoked: "révoqué",
        active: "actif",
  ...
  mcpPage: {
    ...
    commands: {
      title: "Commandes opérateur MCP",
      subtitle: "État, diagnostics, auth, sonde et rechargement runtime.",
    },
    servers: {
      title: "Serveurs configurés",
      subtitle:
        "Les changements runtime s'appliquent après enregistrement et publication ; les agents actifs reconstruisent les runtimes MCP à la prochaine utilisation.",
      empty: "Aucun serveur MCP configuré.",
      enable: "Activer",
      disable: "Désactiver",
      toolFilter: "filtre d'outils",
      parallel: "parallèle",
      tlsVerifyOff: "vérif. TLS désactivée",
      mtls: "mTLS",
  ...
  skillWorkshop: {
    ...
    revision: {
      reviseVerb: "Réviser",
      tweakVerb: "Ajuster",
      proposalEyebrow: "Proposition à {verb}",
      close: "Fermer",
      copy: "Indiquez à l'agent ce qui doit changer. La proposition reste en attente et l'atelier créera une version révisée.",
      placeholder:
        "Exemple : utiliser les libellés Gmail plutôt que la recherche non lus, et ajouter une étape dry-run plus sûre.",
      preparingHandoff: "Préparation du transfert de révision",
      sending: "Envoi…",
      sendRevision: "Envoyer la révision",
    },
    board: {
      resizeList: "Redimensionner la liste des propositions",
      searchPlaceholder: "Rechercher des propositions…",
      edited: "Modifié {when}",
      created: "Créé {when}",
      supportFiles: "{count} fichiers de support",
      zeroSupportFiles: "0 fichier de support",
      previous: "Précédent",
      next: "Suivant",
      loadingProposal: "Chargement de la proposition…",
      supportFilesSection: "Fichiers de support",
    ...
    queue: {
      ...
      noStatusProposals: "Aucune proposition {status}.",
      noMatchFilter: "Aucune proposition ne correspond au filtre actuel.",
    },
    empty: {
      noMatch: {
        title: "Aucune proposition correspondante",
        body: "Effacez la recherche ou essayez un autre mot-clé.",
      },
      pending: {
        title: "Aucune proposition en attente",
        body: "Les nouveaux brouillons apparaîtront ici pour révision.",
      },
      applied: {
        title: "Rien d'appliqué pour l'instant",
        body: "Utilisez une proposition en attente et elle apparaîtra ici comme compétence active.",
      },
      rejected: {
        title: "Aucune proposition rejetée",
        body: "Les propositions ignorées resteront ici pour l'historique de révision.",
      },
      quarantined: {
        title: "Rien en quarantaine",
        body: "Les propositions bloquées par le scanner ou la sécurité apparaîtront ici.",
      },
      stale: {
        title: "Aucune proposition obsolète",
        body: "Les propositions qui ne peuvent plus s'appliquer proprement apparaîtront ici.",
      },
      all: {
        title: "Aucune proposition ici",
        body: "Les propositions de l'atelier apparaîtront ici quand votre agent en rédigera.",
      },
    },
    workshopEmpty: {
      ariaLabel: "Aucune proposition d'atelier de compétences",
      eyebrow: "Atelier Skills",
      title: "Aucune proposition pour l'instant",
      noDrafts: "{agent} n'a rédigé aucune proposition de compétence.",
      footer: "Les nouvelles propositions apparaîtront ici pour révision.",
      defaultAgent: "Votre agent",
    },
    today: {
      nothingWaiting: "Rien en attente aujourd'hui",
      noDraftsBrowse:
      ...
      browseApplied: "Parcourir ce qui est déjà appliqué.",
      ...
      preview: {
        howAgentUses: "Comment l'agent l'utilisera",
        whenAgentUses: "Quand l'agent doit l'utiliser",
      },
      draftedBy: "Rédigé par",
      defaultAgent: "agent",
      supportFile: "fichier de support",
      supportFiles: "fichiers de support",
      comeWithIt: "l'accompagnent.",
      useIt: "Utiliser",
      addToSkills: "Ajouter à vos compétences",
      tweakIt: "Ajuster",
      tweakSub: "Demander à l'agent de modifier quelque chose",
      skip: "Ignorer",
      skipSub: "Pas pour moi",
      skipping: "Ignorer…",
      upNext: "À suivre · {count} de plus en attente",
      seeAll: "Voir toutes les propositions →",
      collection: "Votre collection · {count} en usage",
      manage: "Gérer →",
    },
    relative: {
      secondsAgo: "il y a {count}s",
  ...
  workboard: {
    ...
    detailAutomationSkills: "Compétences: {skills}",
  ...
  dreaming: {
    ...
    advanced: {
      ...
      copyArchivePath: "Copier le chemin d'archive",
    },
    stats: {
    ...
    diarySubtabs: {
      dreams: "Rêves",
      insights: "Insights importés",
      palace: "Palais mémoire",
    },
    explainers: {
      dreams:
        "Ceci est le journal de rêves brut que le système écrit en rejouant et consolidant la mémoire ; utilisez-le pour inspecter ce que le système remarque et où cela reste bruité ou léger.",
      insights:
        "Ce sont des insights importés regroupés depuis l'historique externe ; utilisez-les pour réviser ce que les imports ont révélé avant promotion en mémoire durable.",
      palace:
        "Ceci est la surface wiki mémoire compilée que le système peut rechercher et raisonner ; inspectez les pages, affirmations, questions ouvertes et contradictions plutôt que les chats sources bruts.",
    },
    wikiUnavailable: {
      title: "Memory Wiki n'est pas activé",
      bundledPrefix:
        "Les insights importés et le Palais mémoire sont fournis par le plugin intégré ",
      bundledSuffix: ".",
      enablePrefix: "Activez ",
      enableSuffix: ", puis rechargez cet onglet.",
      howToEnable: "Comment activer",
      openConfig: "Ouvrir la config",
    },
    imports: {
      loading: "Chargement des insights importés…",
      emptyTitle: "Aucun insight importé pour l'instant",
      emptyHint:
        "Lancez un import ChatGPT avec apply pour afficher ici les insights importés regroupés.",
      clusteredAround: "Chats importés regroupés autour de {label}.",
      digestWithheldOne: " {count} digeste a été retenu en attente de révision.",
      digestWithheldMany: " {count} digests ont été retenus en attente de révision.",
      chats: "{count} chats",
      sensitive: "{count} sensible",
      signals: "{count} signaux",
      messages: "{count} messages",
      potentiallyUsefulSignals: "Signaux potentiellement utiles",
      correctionsOrRevisions: "Corrections ou révisions",
      importDetails: "Détails de l'import",
      startedWith: "Commencé avec :",
      endedOn: "Terminé le :",
      messagesLabel: "Messages :",
      messagesSummary: "{userCount} utilisateur · {assistantCount} assistant",
      riskReasons: "Raisons de risque :",
      labels: "Libellés :",
      openSourcePage: "Ouvrir la page source",
    },
    palace: {
      loading: "Chargement du palais mémoire…",
      emptyTitle: "Le palais mémoire n'est pas encore peuplé",
      emptyHint:
        "Pour l'instant le wiki contient surtout des imports sources bruts et des rapports opérationnels. Cet onglet devient utile quand des synthèses, entités ou concepts commencent à être écrits.",
      vault: "Coffre",
      fullBreakdown: "Répartition complète du coffre : {breakdown}.",
      ...
      wikiPageLabel: "Page wiki :",
      idLabel: "Id :",
      openWikiPage: "Ouvrir la page wiki",
      kindEntity: "entité",
      kindConcept: "concept",
      kindSource: "source",
      kindSynthesis: "synthèse",
      kindReport: "rapport",
      countSources: "Sources",
      countSyntheses: "Synthèses",
      countReports: "Rapports",
      countEntities: "Entités",
      countConcepts: "Concepts",
      clusterSummary: "{label} : {pageCount}",
      onPages: " sur {pageCount}",
    },
    preview: {
      fallbackTitle: "Aperçu wiki",
      loading: "Chargement de la page wiki…",
      notFound: "Aucune page wiki trouvée pour {lookup}.",
      truncatedWithLines: "Affichage du premier extrait de cette page ({count} lignes au total).",
      truncatedWithoutLines: "Aperçu tronqué.",
    },
    importBadge: {
    ...
    counts: {
      ...
      claimRowMany: "{count} lignes d'affirmation",
      openQuestionOne: "{count} question ouverte",
      openQuestionMany: "{count} questions ouvertes",
      contradictionOne: "{count} contradiction",
      contradictionMany: "{count} contradictions",
      recall: "{count} rappel",
      daily: "{count} quotidien",
      phaseHit: "{count} occurrence de phase",
    },
    diary: {
