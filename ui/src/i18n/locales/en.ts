...
export const en: TranslationMap = {
  ...
  configForm: {
    ...
    sections: {
      ...
      skills: { label: "Competencies", description: "Competency packs and capabilities" },
      ...
      meta: { label: "Metadata", description: "Connector metadata and version information" },
      ...
      session: { label: "Conversation", description: "Conversation management and persistence" },
      cron: { label: "Schedules", description: "Scheduled tasks and automation" },
  ...
  overview: {
    access: {
      title: "IntelliSoins Connector Access",
