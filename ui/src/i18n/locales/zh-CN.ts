...
export const zh_CN: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "在手机上？从桌面运行 intellisoins dashboard --no-open 复制完整 URL（包括 #token=...）。",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — 使用 intellisoins models auth 重新认证",
  ...
  login: {
    ...
    failure: {
      ...
      pairing: {
        ...
        stepList: "在 Gateway 主机上运行 intellisoins devices list。",
        stepApproveId: "批准此请求：intellisoins devices approve {requestId}。",
      ...
      protocol: {
        ...
        stepDashboard:
          "使用 intellisoins dashboard 重新打开提供的 dashboard，确保 UI 和 Gateway 来自同一安装。",
        stepDevUi: "如果使用 pnpm ui:dev，请基于当前 checkout 重新构建或重启开发 UI。",
        stepRestart: "更新 IntelliSoins 后重启 Gateway，使其提供当前协议。",
      },
      network: {
        title: "无法连接",
        summary: "浏览器无法完成 Gateway 连接。重试凭据前请检查目标和传输方式。",
        stepGateway: "使用 intellisoins status 或 intellisoins gateway run 确认 Gateway 正在运行。",
        stepUrl: "检查 WebSocket URL；当 Gateway 位于 HTTPS/Tailscale Serve 后面时使用 wss://。",
        stepDashboard:
          "使用 intellisoins dashboard --no-open 重新打开 dashboard，以重新复制当前 URL 和认证详情。",
      },
    },
  },
  chat: {
