...
| ollama              | Ollama                               | llm          | 11434 | 127.0.0.1 | brew       | No            | /api/tags          |
| omlx                | oMLX (multi-model, KV cache RAM+SSD) | llm          | 8010  | 127.0.0.1 | brew       | No            | /health            |

## Categories

| Category     | Servers                                                                                                                       | Purpose                                                      |
| ------------ | ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| llm          | mlxcel, medgemma-27b, qwen3-email, nemotron-30b, qwen3-merged, gemma3-4b, gemma4-12b, qwen35-35b, litellm-proxy, ollama, omlx | Text generation, chat, tools, proxy routing                  |
