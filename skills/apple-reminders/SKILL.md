...
description: "Gérer Apple Rappels via le CLI remindctl (lister, ajouter, modifier, compléter, supprimer). Supporte les listes, filtres par date et sortie JSON/texte."
