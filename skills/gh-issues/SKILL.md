---
name: gh-issues
description: "Récupérer les issues GitHub, spawner des sous-agents pour implémenter des correctifs et ouvrir des PRs, puis surveiller et traiter les commentaires de revue. Usage : /gh-issues [owner/repo] [--label bug] [--limit 5] [--milestone v1.0] [--assignee @me] [--fork user/repo] [--watch] [--interval 5] [--reviews-only] [--cron] [--dry-run] [--model glm-5] [--notify-channel -1002381931352]"
user-invocable: true
metadata:
  {
    "openclaw":
